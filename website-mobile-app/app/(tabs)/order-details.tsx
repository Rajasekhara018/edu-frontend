    ...
    items: [
      {
        ...
        subtitle: 'Weekend batch, mentor-led',
    ...
    items: [
      {
        id: 'itm-2',
        productId: 11,
        title: 'Cloud & DevOps Pro Program',
        subtitle: 'Live cohort, capstone included',
    ...
    items: [
      {
        id: 'itm-3',
        productId: 1,
        title: 'Career acceleration bundle',
        subtitle: '4 courses, 2 workshops, 2 mentor sessions',
        image: 'https://i.imgur.com/0y8Ftya.png',
        qty: 1,
        price: 319,
      },
          ...
          <View style={styles.modalCard}>
            ...
            <ScrollView contentContainerStyle={styles.modalContent}>
              <View style={styles.invoiceCard}>
                <Text style={styles.invoiceTitle}>{profile.branding.name} Enrollment Invoice</Text>
