...
const resources = {
  en: {
    common: {
      ...
      home_title: 'EduSoft',
      home_subtitle: 'Career-ready learning. Mentor support.',
      home_search_placeholder: 'Search full stack, data science, cloud...',
      ...
      cart_empty_subtitle: 'Browse programs and add them to your shortlist.',
      ...
      login_subtitle: 'Sign in to manage enrollments, payments, and saved programs.',
      ...
      register_subtitle: 'Join EduSoft to save programs, track enrollments, and plan your learning path.',
