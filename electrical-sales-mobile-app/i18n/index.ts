...
const resources = {
  en: {
    common: {
      ...
      home_title: 'ElectraMart',
      home_subtitle: 'Electrical supplies. Fast dispatch.',
      home_search_placeholder: 'Search lighting, cables, switches...',
      ...
      cart_empty_subtitle: 'Browse electrical products and add them to your cart.',
      ...
      login_subtitle: 'Sign in to manage orders, quotations, and repeat purchases.',
      ...
      register_subtitle: 'Join ElectraMart to save lists, track orders, and manage project purchases.',
