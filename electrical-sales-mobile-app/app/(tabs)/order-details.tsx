    ...
    items: [
      {
        id: 'itm-1',
        productId: 2,
        title: 'Modular switch combo',
        subtitle: '12A switch set, white finish',
    ...
    items: [
      {
        id: 'itm-2',
        productId: 11,
        title: 'LED panel light pack',
        subtitle: 'Pack of 4, 12W daylight',
    ...
    items: [
      {
        id: 'itm-3',
        productId: 1,
        title: 'Project essentials bundle',
        subtitle: 'Core electricals pack, 8 items',
        image: 'https://i.imgur.com/0y8Ftya.png',
        qty: 1,
        price: 319,
      },
          ...
          <View style={styles.modalCard}>
            ...
            <ScrollView contentContainerStyle={styles.modalContent}>
              <View style={styles.invoiceCard}>
                <Text style={styles.invoiceTitle}>{profile.branding.name} Tax Invoice</Text>
