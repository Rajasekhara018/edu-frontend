...
const resources = {
  en: {
    common: {
      ...
      home_title: 'ThreadLine',
      home_subtitle: 'Style drops. Wardrobe staples.',
      home_search_placeholder: 'Search dresses, sneakers, bags...',
      ...
      cart_empty_subtitle: 'Browse fashion products and add them to your bag.',
      ...
      login_subtitle: 'Sign in to manage orders, track delivery, and save your favorite styles.',
      ...
      register_subtitle: 'Join ThreadLine to save looks, track orders, and manage your wardrobe picks.',
