...
public class UserController {
    ...
    public ResponseObject distributorGetAll() {
        ResponseObject response = new ResponseObject();
    ...
    @RequestMapping(value = {"/filterData"}, method = RequestMethod.POST, consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    @RequestMapping(value = {"/inq"}, method = RequestMethod.POST, produces = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    ...
    public ResponseObject approve(@RequestBody RequestObject request) {
        ResponseObject response = new ResponseObject();
        return Optional.ofNullable(request).filter(req -> "APPROVE".equalsIgnoreCase(req.getReqType()) && req.getKey() != null).map(data -> userService.approveUser(data.getKey())).orElseGet(() -> {
