...
import { CommonInqReqObject, CommonReqObject, CommonReqObjectVo, DetailErrorModule, ErrorMessageModule, RequestObject, ResObjectModule, ResponseObject, ToastMessage } from '../Services/model';
...
export class PayeaseRestservice {
  ...
  private postObservable(reqData: any, messageID: string) {
    ...
    let apiUrl = '';
    apiUrl = "http://65.2.171.228:8070" + messageID;
