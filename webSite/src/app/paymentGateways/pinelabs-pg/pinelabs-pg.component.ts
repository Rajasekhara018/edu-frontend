...
@Component({
  selector: 'app-pinelabs-pg',
  templateUrl: './pinelabs-pg.component.html',
  styleUrls: ['./pinelabs-pg.component.scss']
})
export class PinelabsPgComponent {
  paymentChannel!: string;
  walletsAppsList = ['ApplePay','GooglePay','PayPal','Zelle','Venmo','PhonePay','AmazonPay'];

  isLeftAligned: boolean = true; // Default alignment
  ...
  isWalletApp(paymentChannel: any) {
    if(this.paymentChannel == 'ApplePay') {
  }
}
