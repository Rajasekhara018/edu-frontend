...
const resources = {
  en: {
    common: {
      ...
      home_title: 'GoodsGo',
      home_subtitle: 'Live dispatch. Freight visibility.',
      home_search_placeholder: 'Search FTL, PTL, warehousing...',
      ...
      cart_empty_subtitle: 'Browse transport services and add them to your booking list.',
      ...
      login_subtitle: 'Sign in to manage bookings, track shipments, and review dispatch activity.',
      ...
      register_subtitle: 'Join GoodsGo to save transport services, track shipments, and manage dispatch requests.',
