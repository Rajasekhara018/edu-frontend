...
const orders: OrderDetails[] = [
    ...
    items: [
      {
        id: 'itm-1',
        productId: 2,
        title: 'FTL Hyderabad to Pune',
        subtitle: '9-ton load, scheduled pickup',
  ...
  },
  {
    ...
    status: 'delivered',
    total: 442,
    paymentMethod: 'Credit Card XXXX 1189',
    ...
    items: [
      {
        id: 'itm-2',
        productId: 11,
        title: 'Cold-chain express booking',
        subtitle: 'Temperature-controlled, same-day dispatch',
    ...
    items: [
      {
        id: 'itm-3',
        productId: 1,
        title: 'Multi-stop dispatch plan',
        subtitle: '3 drops, 2 hubs, live tracking enabled',
        image: 'https://i.imgur.com/0y8Ftya.png',
        qty: 1,
        price: 319,
      },
          ...
          <View style={styles.modalCard}>
            ...
            <ScrollView contentContainerStyle={styles.modalContent}>
              <View style={styles.invoiceCard}>
                <Text style={styles.invoiceTitle}>{profile.branding.name} Service Invoice</Text>
