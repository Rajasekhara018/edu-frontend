...
@Component({
  ...
  `,
  styles: [
    ".list-stack { display: flex; flex-direction: column; gap: 1rem; background: var(--panel-bg); padding: 1.5rem; border-radius: 1.25rem; border: 1px solid var(--border); box-shadow: var(--shadow); }",
    ".page-head { display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; }",
    ".page-head h2 { margin: 0; color: var(--text); }",
    "form.filters { display: flex; gap: 1rem; flex-wrap: wrap; }",
    "label { display: flex; flex-direction: column; font-size: 0.85rem; gap: 0.25rem; color: color-mix(in srgb, var(--text) 82%, white); font-weight: 600; }",
    "input, select { border: 1px solid var(--border); padding: 0.55rem 0.75rem; border-radius: 0.75rem; min-width: 180px; color: var(--text); background: white; }",
    ...
    ".booking-card { display: flex; justify-content: space-between; align-items: center; gap: 1rem; padding: 1rem; border: 1px solid var(--border); background: var(--panel-muted-bg); border-radius: 1rem; }",
    ".booking-main h3 { margin: 0.2rem 0 0.35rem; color: var(--text); }",
    ...
    ".booking-side strong { font-size: 1.15rem; color: var(--text); }",
    "a, button { padding: 0.6rem 0.95rem; border-radius: 999px; border: none; background: linear-gradient(135deg, var(--brand), var(--brand-strong)); color: var(--inverse-text); text-decoration: none; cursor: pointer; }",
    ".pay-btn { background: linear-gradient(135deg, var(--panel-strong-bg), color-mix(in srgb, var(--panel-strong-bg) 88%, white)); }",
    "button:disabled { background: color-mix(in srgb, var(--text) 22%, white); cursor: not-allowed; }",
